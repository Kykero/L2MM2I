...
public class ListeChaine implements Liste {
	private class Chainon{//Créer une classe Chainon
		public int val; //Valeur que contient le chainon
	...
	public ListeChaine() {//On initialise les élements de la liste à null
		tete=null;
		queue=null;
		ec=null;
	...
	public static void main(String[] args) {
		ListeChaine l1=new ListeChaine();
		ListeChaine l2=new ListeChaine();
		int i=0;
		l1.ajoutd(2);
		l1.ajoutd(3);
		l1.ajoutd(4);
		...
		l1.ithelement(1);//déplace le pointeur élement courant en position  c'est à dire sur le pointeur queue dans ce cas la.
		l1.oterec();
	...
	public void enqueue() {//Place l'élément courant en queue de la liste
	 ...
	 public int valec() {//Renvoie la valeur contenue dans le chainon où est placé l'élément courant.
		 if(horsListe()) {
	...
	public void modifec(int x) {//Modifie la valeur contenue, dans le chainon de l'élément courant.
		 if(horsListe()) {
			 System.out.println("ListeChaine : valec() : Erreue : hors liste !");
			 System.exit(-1);
		 }
	...
	public void ajoutd(int x) {//Ajoute un chainon contenant la valeur x, à droite du chainon où est placé le pointeur ec.
	...
	public void ajoutg(int x) {//Ajoute un chainon contenant la valeur x, à gauche du chainon où est placé le pointeur ec.
	...
	public int ithelement(int i) {//déplace le pointeur ec à la position i et retourne la valeur qu'il contient.
		//Chainon pt=ec;
		entete();
		int cpt=0;
		int n;
	...
	public boolean egal(ListeChaine I) {//Renvoie vrais ou faux sur l'égalité de 2 listes.
		boolean flag=true;
		Chainon p1=ec;
		Chainon p2=I.ec;
		entete();
